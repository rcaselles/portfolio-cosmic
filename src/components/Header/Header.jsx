...
const Header = () => {
  ...
  const linkClass = (path) => {
    return `block py-2 px-3 md:p-0 rounded md:bg-transparent hover:font-bold hover:tracking-normal ${
      currentRoute === path
        ? "font-bold bg-blue-700 md:text-gray-900 md:dark:text-gray-500"
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://rcaselles.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">rcaselles</span>
        </a>
